classdef progressbar < handle
    ...
    methods
        ...
        function obj = progressbar(fig, pos, range)
            ...
            obj.panel = uipanel('Parent', fig, 'Units', 'Inches', ...
                'Position', [pos(1) pos(2) obj.width obj.height]);
            obj.range_ax = axes('Parent', obj.panel, ...
                'Units', 'Inches', 'Position', [0 0 obj.width obj.height], ...
                'XTickLabel', '', 'XTick', [], 'YTickLabel', '', 'YTick', []);
            obj.pbar = patch([range(1) range(1) range(1) range(1)], [0 0 2 2], ...
                [.75 .75 .9], 'Parent', obj.range_ax);
            obj.ptext = text(obj.width/3, obj.height/2, '0%', 'Parent', obj.range_ax, ...
